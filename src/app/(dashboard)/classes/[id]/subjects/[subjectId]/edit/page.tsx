...
export default function EditSubjectPage() {
  ...
  const onSubmit = async (data: UpdateSubjectData) => {
    try {
      ...
      router.push(`/classes/${classId}/subjects/${subjectId}`);
    } catch (error: any) {
  ...
  if (error || !subject) {
    return (
      <div className="flex flex-col items-center justify-center h-64 pt-6">
        <AlertCircle className="w-12 h-12 text-destructive mb-4" />
        <h2 className="text-2xl font-bold mb-2">Subject Not Found</h2>
        <p className="text-muted-foreground mb-4">
          The subject you're trying to edit doesn't exist.
        </p>
      ...
      <div className="space-y-6 pt-6 max-w-6xl mx-auto">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Edit the basic information for this subject
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-medium">Subject Type</h3>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex items-center gap-2">
                      ...
                      <FormLabel className="!mt-0">Optional Subject</FormLabel>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex items-center gap-2">
                      ...
                      <FormLabel className="!mt-0">Elective Subject</FormLabel>
                    </FormItem>
                  )}
                />
              </div>
          ...
          {fields.length === 0 ? (
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <Button type="button" onClick={addComponent} className="mt-4">
                  <Plus className="w-4 h-4 mr-2" />
                  Add Component
                </Button>
              </CardContent>
            ...
            <div className="space-y-4">
              {fields.map((field, componentIndex) => {
                const component = form.watch(`components.${componentIndex}`);
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="e.g., Theory" {...field} />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                            ...
                            return (
                              <div
                                ...
                                className={cn(
                                  ...
                                  batch.id ? "bg-muted/20" : "bg-amber-50",
                                )}
                              >
                                ...
                                {(form.watch(
                                  ...
                                  <Button
                                    ...
                                    className="mt-6"
                                    onClick={() =>
                                      removeBatch(componentIndex, batchIndex)
                                    }
                                  >
